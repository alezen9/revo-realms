    ...
    if (caster) {
      ...
      for (
        ...
        for (
          ...
          const localPageX = pageX - SHADOW_MINIMUM_PAGE_COORDINATE;
          const localPageY = pageY - SHADOW_MINIMUM_PAGE_COORDINATE;
          this.requestValues[requestCount] =
            localPageY * SHADOW_PAGE_GRID_SIZE + localPageX;
          requestCount++;
        }
      }
    }
